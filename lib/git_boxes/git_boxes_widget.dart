...
import 'git_boxes_model.dart';
export 'git_boxes_model.dart';

class GitBoxesWidget extends StatefulWidget {
  const GitBoxesWidget({super.key});

  @override
  State<GitBoxesWidget> createState() => _GitBoxesWidgetState();
}

class _GitBoxesWidgetState extends State<GitBoxesWidget>
    with TickerProviderStateMixin {
  late GitBoxesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GitBoxesModel());
