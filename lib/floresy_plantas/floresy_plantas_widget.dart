...
import 'floresy_plantas_model.dart';
export 'floresy_plantas_model.dart';

class FloresyPlantasWidget extends StatefulWidget {
  const FloresyPlantasWidget({super.key});

  @override
  State<FloresyPlantasWidget> createState() => _FloresyPlantasWidgetState();
}

class _FloresyPlantasWidgetState extends State<FloresyPlantasWidget>
    with TickerProviderStateMixin {
  late FloresyPlantasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FloresyPlantasModel());
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      FlutterFlowChoiceChips(
                                        options: [
                                          ChipData('Astromelias'),
                                          ChipData('Blue Flowers'),
                                          ChipData('Gerberas'),
                                          ChipData('Girasoles'),
                                          ChipData('Liliums'),
                                          ChipData('Orquídeas'),
                                          ChipData('Primaverales'),
                                          ChipData('Tulipanes'),
                                          ChipData('Tropicales'),
                                          ChipData('Mes del Amor')
                                        ],
