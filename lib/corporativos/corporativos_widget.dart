...
import 'corporativos_model.dart';
export 'corporativos_model.dart';

class CorporativosWidget extends StatefulWidget {
  const CorporativosWidget({super.key});

  @override
  State<CorporativosWidget> createState() => _CorporativosWidgetState();
}

class _CorporativosWidgetState extends State<CorporativosWidget>
    with TickerProviderStateMixin {
  late CorporativosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CorporativosModel());
