...
import 'condolencias_model.dart';
export 'condolencias_model.dart';

class CondolenciasWidget extends StatefulWidget {
  const CondolenciasWidget({super.key});

  @override
  State<CondolenciasWidget> createState() => _CondolenciasWidgetState();
}

class _CondolenciasWidgetState extends State<CondolenciasWidget>
    with TickerProviderStateMixin {
  late CondolenciasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CondolenciasModel());
                                ...
                                Padding(
                                  ...
                                  child: SingleChildScrollView(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        FlutterFlowChoiceChips(
                                          options: [ChipData('Portalágrimas')],
                                          onChanged: (val) => setState(() =>
