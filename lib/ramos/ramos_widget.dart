...
import 'ramos_model.dart';
export 'ramos_model.dart';

class RamosWidget extends StatefulWidget {
  const RamosWidget({super.key});

  @override
  State<RamosWidget> createState() => _RamosWidgetState();
}

class _RamosWidgetState extends State<RamosWidget>
    with TickerProviderStateMixin {
  late RamosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RamosModel());
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      FlutterFlowChoiceChips(
                                        options: [
                                          ChipData('Ramos'),
                                          ChipData('Ramos Premium'),
                                          ChipData('Flores Preservadas'),
                                          ChipData('Floreros')
                                        ],
